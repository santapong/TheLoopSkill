...
// embodies the writing-docs ACCURACY rule (SKILL.md §5): a drafted doc that cannot be
...
// EDIT ME: doc type the drafters target — see writing-docs SKILL.md §1 (Diataxis + artifact types).
