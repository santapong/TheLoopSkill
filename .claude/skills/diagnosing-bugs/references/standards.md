...
Re-verify these editions on a periodic cadence (mirror the re-check discipline in `../../reviewing-code/references/owasp-cwe.md`), and do not mix editions of the same standard within one diagnosis.
